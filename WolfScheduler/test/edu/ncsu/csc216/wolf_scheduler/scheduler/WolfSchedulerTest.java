...
public class WolfSchedulerTest {
	...
	/**
	 * Tests to see if a conflict exception is thrown when adding conflicting activities
	 */
	@Test
	public void testAddCourseToScheduleConflict() {
		...
		IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> ws.addCourseToSchedule("CSC 217", "202"));
	 ...
	 */
	@Test
	public void testAddEventToScheduleConflict() {
		
		WolfScheduler ws = new WolfScheduler(validTestFile);
		
		ws.addEventToSchedule(TITLE, EVENT_MEETING_DAYS, START_TIME, END_TIME, EVENT_DETAILS);
		...
		IllegalArgumentException e = assertThrows(IllegalArgumentException.class, 
				() -> ws.addEventToSchedule("Sleep", EVENT_MEETING_DAYS, START_TIME, END_TIME, EVENT_DETAILS));
